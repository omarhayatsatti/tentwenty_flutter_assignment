...
class _WatchPageViewState extends State<WatchPageView> with TickerProviderStateMixin {
                ...
                if (state.upComingMoviesResponse.results != null &&
                  ...
                  return   Column(
                    children: [
                          ...
                          child: RefreshIndicator(child: ListView.builder(
                            ...
                            return Stack(children: [
                              ...
                              Container(
                                ...
                                margin: EdgeInsets.only(left: 12.0,right: 15.0,top: 20.0),
                                ...
                                child: Hero(
                                  ...
                                  child: NetworkImageService(
                                    ...
                                    imageHeight: getScreenHeight(context) * 0.30,
                      ...
                      BlocConsumer<UpComingMoviesLoadMoreBloc, UpComingMoviesLoadMoreState>(
                          listener: (context,state){
                          },
                          builder: (context, state) {
                            ...
                            if (state is UpComingMoviesLoadMoreLoaded) {
                              updateList(state.upComingMoviesResponse,state.upComingMoviesResponse.httpStatus);
                              BlocProvider.of<UpComingMoviesLoadMoreBloc>(context).add(UpComingMoviesLoadMoreFinishEvent());
                              return Container();
                  ...
                  return Container(child: AppText(text: "no movie found"),);
                }
              }
              else{
                return Container();
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      setState(() {
        if(upComingMoviesResponse.results.length!=0) {
          ...
          controllerActive.jumpTo(controllerActive.position.maxScrollExtent+200);
          //page++;
        }
  ...
  void _scrollListener() {
    if (!isLoading && controllerActive.position.pixels == controllerActive.position.maxScrollExtent &&  page<=totalPage) {
      isLoading = true;
  ...
  void initState() {
    ...
    _upComingMoviesLoadMoreBloc = BlocProvider.of<UpComingMoviesLoadMoreBloc>(context);
